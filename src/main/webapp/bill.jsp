...
try{    	String grain_id=request.getParameter("id");
      ...
      ResultSet rs=st.executeQuery("select * from grains where grains_id='"+grain_id+"'");
	    while(rs.next())
	    {
	    	...
	    	int q2=Integer.parseInt(rs.getString("grains_stock"));
	    	if(q2>=q){
...
<div class="userprofile">
  ...
  <p class="point"><b>Grain Id:</b><%=rs.getString("grains_id")%> </p>
      ...
      <%int price=Integer.parseInt(rs.getString("grains_price"));
  ...
  <!--   <form action="" method="post">-->
        <input type="text" name="g_id" value="<%=rs.getString("grains_id")%>" style="display:none">
        <input type="text" name="f_id" value="<%=rs.getString("f_id")%>" style="display:none">
...
<script
    ...
    data-name="GrainsMart"
    data-description="Make Happy order!!"
    data-image="https://example.com/your_logo.jpg"
    data-prefill.name="shubham"
